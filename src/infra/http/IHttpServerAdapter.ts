export interface getAndDeleteCallbackType { (params: any, qyery: any): Promise<any> }
...
export interface postAndPutCallbackType { (params: any, qyery: any, body: any): Promise<any> }
